...
lib.ssMetadata = [
		{name:"IFM_Display_Profound_300x600_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Thumb = function() {
	this.initialize(ss["IFM_Display_Profound_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(68.35,24.325);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(56.925,19.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgIBqIAAjTIAQAAIAADTg");
	this.shape_2.setTransform(45.8,14.925);
	...
	this.shape_3.setTransform(34.075,15.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgIBgIAAiAIARAAIAACAgAgIhKQgDgEAAgFQAAgGADgDQAEgDAEAAQAGAAADADQAEADgBAGQABAFgEAEQgDAEgGAAQgEAAgEgEg");
	this.shape_4.setTransform(22,15.85);
	...
	this.shape_5.setTransform(12.475,19.025);
	...
	this.shape_6.setTransform(0.575,19.025);
	...
	this.shape_7.setTransform(-13.45,19.025);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(-30.125,22.05);
	...
	this.shape_9.setTransform(-52.275,19.025);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgHBgIAAiAIAQAAIAACAgAgIhKQgEgEAAgFQAAgGAEgDQAEgDAEAAQAGAAADADQAEADgBAGQABAFgEAEQgDAEgGAAQgEAAgEgEg");
	this.shape_10.setTransform(-61.35,15.85);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(79.225,-14.225);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AggBDIAAhcIAAgJIgBgLIAAgKIgBgHIARAAIABAOIAAAJQAHgLAJgIQAKgHAPgBIAFABIAEABIgBAQIgHgBQgLABgIADQgHADgFAGQgFAHgDAIQgDAIAAAKIAABGg");
	this.shape_1.setTransform(68.2,-14.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(55.25,-14.225);
	...
	this.shape_3.setTransform(42.025,-14.225);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(18.725,-18.15);
	...
	this.shape_5.setTransform(2.525,-14.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgfA9QgJgEgGgIQgFgHgCgKQgCgLAAgKIAAhNIAQAAIAABMIACAPQABAHAEAHQADAFAHAEQAGADAKAAQAIAAAJgDQAIgDAGgGQAGgHADgKQAEgLAAgMIAAhBIARAAIAABcIAAAJIAAALIABAKIAAAHIgRAAIAAgOIgBgIIgBAAQgFAKgLAIQgMAHgPABQgPAAgKgGg");
	this.shape_6.setTransform(-13.025,-14.05);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(-29.05,-14.225);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgOBsIAAhyIgbAAIAAgPIAbAAIAAgqQAAgNADgIQAEgIAFgGQAFgEAHgDQAHgCAGAAQAMABAHADIgDAOQgGgCgJAAQgXgBAAAjIAAAkIAeAAIAAAPIgeAAIAAByg");
	this.shape_8.setTransform(-40.85,-18.5);
	...
	this.shape_9.setTransform(-53.9,-14.225);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AggBDIAAhcIAAgJIgBgLIAAgKIgBgHIARAAIABAOIAAAJQAHgLAJgIQAKgHAOgBIAGABIAEABIgBAQIgHgBQgLABgIADQgHADgFAGQgFAHgDAIQgDAIAAAKIAABGg");
	this.shape_10.setTransform(-65.45,-14.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("Ag7BjIAAjFIA4AAQAKAAAMACQALACAJAHQAJAGAHAJQAFALAAAPQABAOgFAKQgFAJgJAHQgHAGgMACQgLADgLAAIgqAAIAABegAgpgLIApAAQAIAAAHgBQAIgCAGgFQAGgDAEgIQADgGAAgKQAAgKgDgGQgFgHgFgEQgHgEgHgDQgIgCgHAAIgpAAg");
	this.shape_11.setTransform(-78.3,-17.65);
...
// stage content:
(lib.IFM_Display_Profound_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_2.setTransform(149.95,203.55,1.215,1.215);
	...
	this.instance_3.setTransform(149.95,203.55,1.215,1.215);
	...
	this.instance_4.setTransform(149.95,202.8,1.215,1.215);
	...
	this.instance_5.setTransform(243.75,414.4,0.25,0.25,0,0,0,375,457.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.7,regY:457.1,scaleX:0.74,scaleY:0.74,x:360.25,y:873.75},161,cjs.Ease.sineInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-211.1,-52.8,738.1,1476.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Profound_300x600_atlas_1.jpg?1604691066689", id:"IFM_Display_Profound_300x600_atlas_1"}
	],
	preloads: []
};
