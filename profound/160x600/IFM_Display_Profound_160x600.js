...
lib.ssMetadata = [
		{name:"IFM_Display_Profound_160x600_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Thumb = function() {
	this.initialize(ss["IFM_Display_Profound_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(55.4,57.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(43.975,52.275);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgHBqIAAjTIAPAAIAADTg");
	this.shape_2.setTransform(32.85,48.175);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(21.125,48.35);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgIBhIAAiBIAQAAIAACBgAgIhKQgEgEABgFQgBgGAEgDQAEgEAEAAQAFAAAEAEQADADAAAGQAAAFgDAEQgEADgFAAQgEAAgEgDg");
	this.shape_4.setTransform(9.05,49.1);
	...
	this.shape_5.setTransform(-0.475,52.275);
	...
	this.shape_6.setTransform(-12.375,52.275);
	...
	this.shape_7.setTransform(-26.4,52.275);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(-43.075,55.3);
	...
	this.shape_9.setTransform(32.875,19.025);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgIBgIAAiAIARAAIAACAgAgIhKQgDgEAAgFQAAgGADgDQAEgDAEAAQAGAAADADQAEADgBAGQABAFgEAEQgDAEgGAAQgEAAgEgEg");
	this.shape_10.setTransform(23.8,15.85);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(5.425,19.025);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AggBCIAAhcIAAgIIgBgKIAAgKIgBgIIARAAIABAOIAAAJQAHgMAJgHQAKgIAOABIAGAAIAEABIgBARIgHgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgDAJAAAJIAABFg");
	this.shape_12.setTransform(-5.6,18.85);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("");
	this.shape_13.setTransform(-18.55,19.025);
	...
	this.shape_14.setTransform(-31.775,19.025);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(48.525,-18.15);
	...
	this.shape_1.setTransform(32.325,-14.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgfA9QgJgEgGgIQgFgHgCgKQgCgLAAgKIAAhNIAQAAIAABMIACAPQABAHAEAHQADAFAHAEQAGADAKAAQAIAAAJgDQAIgDAGgGQAGgHADgKQAEgLAAgMIAAhBIARAAIAABcIAAAJIAAALIABAKIAAAHIgRAAIAAgOIgBgIIgBAAQgFAKgLAIQgMAHgPABQgPAAgKgGg");
	this.shape_2.setTransform(16.775,-14.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(0.75,-14.225);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgPBsIAAhyIgbAAIAAgPIAbAAIAAgqQABgNADgIQAEgIAFgGQAFgEAHgDQAHgCAGAAQAMABAHADIgDAOQgFgCgKAAQgXgBAAAjIAAAkIAeAAIAAAPIgeAAIAAByg");
	this.shape_4.setTransform(-11.05,-18.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(-24.1,-14.225);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AggBDIAAhcIAAgJIgBgLIAAgKIAAgHIAQAAIABAOIABAJQAGgLAJgIQAKgHAOgBIAGABIAEABIgCAQIgGgBQgLABgIADQgHADgFAGQgFAHgDAIQgCAIAAAKIAABGg");
	this.shape_6.setTransform(-35.65,-14.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ag7BjIAAjFIA4AAQAKAAAMACQALACAJAHQAJAGAHAJQAFALAAAPQABAOgFAKQgFAJgJAHQgHAGgMACQgLADgLAAIgqAAIAABegAgpgLIApAAQAIAAAHgBQAIgCAGgFQAGgDAEgIQADgGAAgKQAAgKgDgGQgEgHgGgEQgHgEgHgDQgIgCgHAAIgpAAg");
	this.shape_7.setTransform(-48.5,-17.65);
...
// stage content:
(lib.IFM_Display_Profound_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_2.setTransform(80.05,207.55,0.972,0.972,0,0,0,0.1,0.1);
	...
	this.instance_3.setTransform(80.05,207.55,0.972,0.972,0,0,0,0.1,0.1);
	...
	this.instance_4.setTransform(79.95,206.85,0.972,0.972);
	...
	this.instance_5.setTransform(173.75,414.4,0.25,0.25,0,0,0,375,457.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.7,regY:457.1,scaleX:0.74,scaleY:0.74,x:290.25,y:873.75},161,cjs.Ease.sineInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-351.1,-52.8,808.1,1476.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Profound_160x600_atlas_1.jpg?1604691028924", id:"IFM_Display_Profound_160x600_atlas_1"}
	],
	preloads: []
};
