...
lib.ssMetadata = [
		{name:"IFM_Display_Profound_300x50_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Thumb = function() {
	this.initialize(ss["IFM_Display_Profound_300x50_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib._300x600_Thumb();
...
}).prototype = getMCSymbolPrototype(lib.patternthumb40, new cjs.Rectangle(-600,-1200,1200,2400), null);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("ArjDNIAAmZIaFAAIAAGZg");
	mask.setTransform(92.974,5.5);

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgJAKQgDgEAAgGQAAgFADgEQAEgDAFAAQAFAAAEADQAFAEAAAFQAAAGgFAEQgEADgFAAQgFAAgEgDg");
	this.shape.setTransform(155.4,7.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(143.975,2.375);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgHBqIAAjTIAQAAIAADTg");
	this.shape_2.setTransform(132.85,-1.725);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(121.125,-1.55);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgIBgIAAiAIAQAAIAACAgAgIhKQgEgEABgFQgBgGAEgDQAEgDAEAAQAFAAAEADQAEADAAAGQAAAFgEAEQgEAEgFAAQgEAAgEgEg");
	this.shape_4.setTransform(109.05,-0.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(99.525,2.375);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(87.625,2.375);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(73.6,2.375);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(56.925,5.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(34.775,2.375);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgIBgIAAiAIAQAAIAACAgAgIhKQgEgEABgFQgBgGAEgDQAEgDAEAAQAFAAAEADQADADAAAGQAAAFgDAEQgEAEgFAAQgEAAgEgEg");
	this.shape_10.setTransform(25.7,-0.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(7.325,2.375);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AggBCIAAhcIAAgIIgBgKIAAgKIAAgIIAQAAIABAOIABAJQAGgMAJgHQAKgIAOABIAGAAIAEABIgCARIgGgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgCAJAAAJIAABFg");
	this.shape_12.setTransform(-3.7,2.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("");
	this.shape_13.setTransform(-16.65,2.375);
	...
	this.shape_14.setTransform(-29.875,2.375);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(-53.175,-1.55);
	...
	this.shape_16.setTransform(-69.375,2.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgfA+QgJgFgGgIQgFgIgCgKQgCgJAAgMIAAhMIAQAAIAABMIACAPQABAIAEAFQADAHAHACQAGAEAKAAQAIAAAJgDQAIgDAGgHQAGgGADgLQAEgKAAgLIAAhCIARAAIAABdIAAAJIAAAKIABAKIAAAHIgRAAIAAgOIgBgJIgBAAQgFALgLAHQgMAJgPgBQgPAAgKgEg");
	this.shape_17.setTransform(-84.925,2.55);
	...
	this.shape_18.setTransform(-100.95,2.375);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgPBrIAAhxIgbAAIAAgPIAbAAIAAgqQABgNADgIQAEgIAFgGQAFgEAHgCQAHgCAGgBQAMAAAHAEIgDAOQgFgDgKAAQgXABAAAiIAAAkIAeAAIAAAPIgeAAIAABxg");
	this.shape_19.setTransform(-112.75,-1.9);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("");
	this.shape_20.setTransform(-125.8,2.375);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AggBCIAAhcIAAgIIgBgKIAAgKIAAgIIAQAAIABAOIABAJQAGgMAJgHQAKgIAOABIAGAAIAEABIgCARIgGgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgCAJAAAJIAABFg");
	this.shape_21.setTransform(-137.35,2.2);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("Ag7BjIAAjFIA4AAQAKAAAMACQALADAJAFQAJAGAHALQAFAKAAAPQABANgFAKQgFAKgJAGQgHAHgMACQgLADgLAAIgqAAIAABegAgpgLIApAAQAIAAAHgCQAIgCAGgDQAGgFAEgHQADgGAAgKQAAgKgDgGQgEgHgGgEQgHgEgHgCQgIgCgHAAIgpAAg");
	this.shape_22.setTransform(-150.2,-1.05);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1b, new cjs.Rectangle(19,-15,167,36.1), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AxBDNIAAmZMAiDAAAIAAGZg");
	mask.setTransform(-90.05,5.5);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1a, new cjs.Rectangle(-199.1,-15,218.1,36.1), null);
...
// stage content:
(lib.IFM_Display_Profound_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(90.3,25.05,0.96,0.96,0,0,0,0.1,0.1);
	...
	this.instance_1.setTransform(234.25,22.4,0.6,0.6,0,0,0,0.1,10);
	...
	this.instance_2.setTransform(150.65,24.95,0.741,0.741);
	...
	this.instance_3.setTransform(150.65,24.95,0.741,0.741);
	...
	this.instance_4.setTransform(150.7,25,0.741,0.741,0,0,0,0.1,0.1);
	...
	this.instance_5.setTransform(21.75,99.8,0.192,0.192,89.9863,0,0,375.4,457.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.8,regY:456.9,scaleX:0.444,scaleY:0.444,rotation:89.9961,x:-153.85,y:129.35},161,cjs.Ease.sineInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-333.7,-278.6,915.5999999999999,508);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Profound_300x50_atlas_1.jpg?1604691080292", id:"IFM_Display_Profound_300x50_atlas_1"}
	],
	preloads: []
};
