...
lib.ssMetadata = [
		{name:"IFM_Display_Profound_320x50_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Thumb = function() {
	this.initialize(ss["IFM_Display_Profound_320x50_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Profound_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(100.3,25.05,0.96,0.96,0,0,0,0.1,0.1);
	...
	this.instance_1.setTransform(244.25,22.4,0.6,0.6,0,0,0,0.1,10);
	...
	this.instance_2.setTransform(160.65,24.95,0.741,0.741);
	...
	this.instance_3.setTransform(160.65,24.95,0.741,0.741);
	...
	this.instance_4.setTransform(160.7,25,0.741,0.741,0,0,0,0.1,0.1);
	...
	this.instance_5.setTransform(31.75,99.8,0.192,0.192,89.9863,0,0,375.4,457.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.8,regY:456.9,scaleX:0.444,scaleY:0.444,rotation:89.9961,x:-143.85,y:129.35},161,cjs.Ease.sineInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-313.7,-278.6,905.7,508);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Profound_320x50_atlas_1.jpg?1604691022136", id:"IFM_Display_Profound_320x50_atlas_1"}
	],
	preloads: []
};
