...
lib.ssMetadata = [
		{name:"IFM_Display_Profound_300x250_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Thumb = function() {
	this.initialize(ss["IFM_Display_Profound_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Profound_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_5.setTransform(243.75,239.4,0.25,0.25,0,0,0,375,457.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.7,regY:457.1,scaleX:0.74,scaleY:0.74,x:360.25,y:813.75},161,cjs.Ease.sineInOut).wait(18));
...
p.nominalBounds = new cjs.Rectangle(-211.1,-287.8,738.1,1651.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Profound_300x250_atlas_1.jpg?1604691058827", id:"IFM_Display_Profound_300x250_atlas_1"}
	],
	preloads: []
};
