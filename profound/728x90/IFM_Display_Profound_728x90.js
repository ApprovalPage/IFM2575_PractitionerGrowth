...
lib.ssMetadata = [
		{name:"IFM_Display_Profound_728x90_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Thumb = function() {
	this.initialize(ss["IFM_Display_Profound_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Profound_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_5.setTransform(217.6,165.15,0.32,0.32,89.9836,0,0,375.4,457.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.8,regY:457,scaleX:0.74,scaleY:0.74,rotation:89.9941,x:-75.1,y:214.35},161,cjs.Ease.sineInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-261,-462.4,1412.4,843.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Profound_728x90_atlas_1.jpg?1604691072959", id:"IFM_Display_Profound_728x90_atlas_1"}
	],
	preloads: []
};
