...
// stage content:
(lib.IFM_Display_Enhance_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1,x:65.1,y:-68.9},161,cjs.Ease.quadInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-385.1,-1144,1050.1,2275);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Enhance_300x250_atlas_1.jpg?1604618534129", id:"IFM_Display_Enhance_300x250_atlas_1"}
	],
	preloads: []
};
