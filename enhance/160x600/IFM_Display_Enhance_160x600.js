...
lib.ssMetadata = [
		{name:"IFM_Display_Enhance_160x600_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Leaf = function() {
	this.initialize(ss["IFM_Display_Enhance_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(65.8,57.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAnBDIAAhMIgBgPQgCgHgDgGQgEgGgGgEQgGgDgKAAQgIAAgJADQgIADgGAHQgGAGgEALQgDAKAAAMIAABBIgRAAIAAhdIAAgIIgBgLIAAgKIAAgHIAQAAIABAOIABAJIABAAQAFgLALgHQAMgJAPABQAPgBAJAGQAKAFAFAHQAGAIACAKQACAKAAAKIAABNg");
	this.shape_1.setTransform(54.325,52.1);
	...
	this.shape_2.setTransform(38.3,52.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgHBhIAAiBIAQAAIAACBgAgIhKQgDgEgBgFQABgGADgDQAEgEAEAAQAGAAADAEQADADAAAGQAAAFgDAEQgDADgGAAQgEAAgEgDg");
	this.shape_3.setTransform(26.65,49.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAFBSQgGgDgEgEQgEgFgBgFQgCgHAAgHIAAhTIgdAAIAAgPIAdAAIAAglIAPAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAFAFAIgBIAKgBIAJgDIACAQIgMADIgLABQgIAAgGgDg");
	this.shape_4.setTransform(18.5,50.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(6.55,52.275);
	...
	this.shape_6.setTransform(-6.675,52.275);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgfA9QgJgEgGgIQgFgHgCgKQgCgLAAgLIAAhLIAQAAIAABLIACAPQABAHAEAHQADAFAHAEQAGADAKAAQAIAAAJgDQAIgDAGgGQAGgIADgJQAEgLAAgMIAAhAIARAAIAABbIAAAJIAAALIABAKIAAAHIgRAAIAAgOIgBgIIgBAAQgFAKgLAIQgMAHgPABQgPgBgKgFg");
	this.shape_7.setTransform(-21.825,52.45);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(-38.275,48.35);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(-54.425,52.275);
	...
	this.shape_10.setTransform(27.05,18.85);
	...
	this.shape_11.setTransform(13.675,19.2);
	...
	this.shape_12.setTransform(-2.35,19.025);
	...
	this.shape_13.setTransform(-17.125,22.4);
...
// stage content:
(lib.IFM_Display_Enhance_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Enhance_160x600_atlas_1.jpg?1604618545705", id:"IFM_Display_Enhance_160x600_atlas_1"}
	],
	preloads: []
};
