...
lib.ssMetadata = [
		{name:"IFM_Display_Enhance_300x50_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Leaf = function() {
	this.initialize(ss["IFM_Display_Enhance_300x50_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Enhance_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(92.5,25.05,0.96,0.96,0,0,0,0.1,0.1);
	...
	this.instance_1.setTransform(236.45,22.4,0.6,0.6,0,0,0,0.1,10);
	...
	this.instance_2.setTransform(152.85,24.95,0.78,0.78);
	...
	this.instance_3.setTransform(152.85,24.95,0.78,0.78);
	...
	this.instance_4.setTransform(152.85,25,0.78,0.78);
	...
	this.instance_5.setTransform(86,45.05,0.192,0.192,0,0,0,0.2,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0,regY:0.1,scaleX:0.6,scaleY:0.6,x:-84,y:78.05},161,cjs.Ease.quadInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-654,-257.2,1290.1,695.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Enhance_300x50_atlas_1.jpg?1604618538617", id:"IFM_Display_Enhance_300x50_atlas_1"}
	],
	preloads: []
};
