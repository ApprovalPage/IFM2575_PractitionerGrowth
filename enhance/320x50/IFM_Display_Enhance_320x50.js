...
lib.ssMetadata = [
		{name:"IFM_Display_Enhance_320x50_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Leaf = function() {
	this.initialize(ss["IFM_Display_Enhance_320x50_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.patternleaf, new cjs.Rectangle(-1200,-600,2400.1,1200.2), null);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AvxCvIAAldIfjAAIAAFdg");
	mask.setTransform(58.0623,2.5);

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgIAKQgFgEAAgGQAAgFAFgEQAEgDAEAAQAFAAAFADQADAEAAAFQAAAGgDAEQgFADgFAAQgEAAgEgDg");
	this.shape.setTransform(150.05,7.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAnBCIAAhKIgBgQQgCgHgDgGQgEgGgGgDQgGgEgKAAQgIAAgJADQgIADgGAHQgGAHgEAKQgDAJAAANIAABAIgRAAIAAhcIAAgIIgBgKIAAgKIAAgIIAQAAIABAOIABAJIABAAQAFgLALgIQAMgHAPAAQAPAAAJAEQAKAFAFAIQAGAIACAJQACALAAALIAABLg");
	this.shape_1.setTransform(138.575,2.2);
	...
	this.shape_2.setTransform(122.55,2.375);
	...
	this.shape_3.setTransform(110.9,-0.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAFBSQgGgDgEgEQgEgEgBgHQgCgFAAgIIAAhTIgcAAIAAgPIAcAAIAAglIAPAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAEAEAJABIAKgBIAJgEIACAPIgLAEIgMABQgIAAgGgDg");
	this.shape_4.setTransform(102.75,0.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(90.8,2.375);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgQA/QgNgFgJgJQgJgJgFgNQgFgMAAgPQAAgOAFgMQAFgNAJgJQAJgJANgFQAMgFAOAAQAOAAAMAGQANAGAJAKIgNALQgIgJgIgEQgJgFgKAAQgLAAgJAEQgKAFgHAHQgGAHgEAJQgDAKAAAKQAAALADAKQAEAJAGAHQAHAIAKAEQAJAEALAAQALAAAIgFQAJgFAHgIIAMALQgJALgMAGQgMAFgOAAQgOAAgMgFg");
	this.shape_6.setTransform(77.575,2.375);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgfA+QgJgFgGgIQgFgIgCgKQgCgJAAgMIAAhMIAQAAIAABMIACAPQABAIAEAFQADAHAHACQAGAEAKAAQAIAAAJgDQAIgDAGgHQAGgGADgLQAEgKAAgLIAAhCIARAAIAABdIAAAJIAAAKIABAKIAAAHIgRAAIAAgOIgBgJIgBAAQgFALgLAHQgMAJgPgBQgPAAgKgEg");
	this.shape_7.setTransform(62.425,2.55);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(45.975,-1.55);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(29.825,2.375);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AggBCIAAhcIAAgIIgBgKIAAgKIgBgIIARAAIABAOIAAAJQAHgMAJgHQAKgIAOABIAGAAIAEABIgBARIgHgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgDAJAAAJIAABFg");
	this.shape_10.setTransform(11.05,2.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgfA+QgJgFgGgIQgFgIgCgKQgCgJAAgMIAAhMIAQAAIAABMIACAPQABAIAEAFQADAHAHACQAGAEAKAAQAIAAAJgDQAIgDAGgHQAGgGADgLQAEgKAAgLIAAhCIARAAIAABdIAAAJIAAAKIABAKIAAAHIgRAAIAAgOIgBgJIgBAAQgFALgLAHQgMAJgPgBQgPAAgKgEg");
	this.shape_11.setTransform(-2.325,2.55);
	...
	this.shape_12.setTransform(-18.35,2.375);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgxBhIgIgBIACgQIAHACIAIABQAEAAAEgCIAGgFIAEgHIADgIIAMgdIg1iCIATAAIAqBtIAqhtIASAAIhCCpQgFAMgIAIQgJAIgOgBg");
	this.shape_13.setTransform(-33.125,5.75);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("");
	this.shape_14.setTransform(-54.625,2.375);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgQA/QgNgFgJgJQgJgJgFgNQgFgMAAgPQAAgOAFgMQAFgNAJgJQAJgJANgFQAMgFAOAAQAOAAAMAGQANAGAJAKIgNALQgIgJgIgEQgJgFgKAAQgLAAgJAEQgKAFgHAHQgGAHgEAJQgDAKAAAKQAAALADAKQAEAJAGAHQAHAIAKAEQAJAEALAAQALAAAIgFQAJgFAHgIIAMALQgJALgMAGQgMAFgOAAQgOAAgMgFg");
	this.shape_15.setTransform(-68.525,2.375);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAnBCIAAhKIgBgQQgCgHgDgGQgEgGgGgDQgGgEgKAAQgIAAgJADQgIADgGAHQgGAHgEAKQgDAJAAANIAABAIgRAAIAAhcIAAgIIgBgKIAAgKIAAgIIAQAAIABAOIABAJIABAAQAFgLALgIQAMgHAPAAQAPAAAJAEQAKAFAFAIQAGAIACAJQACALAAALIAABLg");
	this.shape_16.setTransform(-83.675,2.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("");
	this.shape_17.setTransform(-98.8,2.375);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AAmBqIAAhMIgBgQQgCgHgDgGQgDgFgHgDQgGgEgKAAQgIAAgJADQgIAEgGAFQgGAHgDAKQgEAKAAANIAABBIgQAAIAAjTIAQAAIAABpIABAAQAFgLALgHQANgIAOAAQAPAAAJAFQAKAFAGAHQAFAIACAJQACAKABALIAABNg");
	this.shape_18.setTransform(-113.65,-1.725);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AAnBCIAAhKIgBgQQgCgHgDgGQgEgGgGgDQgGgEgKAAQgIAAgJADQgIADgGAHQgGAHgEAKQgDAJAAANIAABAIgRAAIAAhcIAAgIIgBgKIAAgKIAAgIIAQAAIABAOIABAJIABAAQAFgLALgIQAMgHAPAAQAPAAAJAEQAKAFAFAIQAGAIACAJQACALAAALIAABLg");
	this.shape_19.setTransform(-129.275,2.2);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("Ag+BjIAAjFIB4AAIAAARIhlAAIAABGIBfAAIAAAQIhfAAIAABNIBqAAIAAARg");
	this.shape_20.setTransform(-144.6,-1.05);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1b, new cjs.Rectangle(-42.9,-15,202,35), null);
...
if (reversed == null) { reversed = false; }
	...
	// type
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0067AF").s().p("AAOAqIgTgkIgLAAIAAAkIgPAAIAAhTIAeAAIAKABIAKADQAFADACAFQADAEAAAIQAAAJgFAGQgFAGgKABIAXAlgAgQgFIAMAAIAFgBIAGgBIAEgEQADgCAAgEQAAgEgCgCIgFgEQgCgBgDAAIgFgBIgNAAg");
	this.shape.setTransform(32.1,14.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#0067AF").s().p("AgcAqIAAhTIA3AAIAAANIgoAAIAAAVIAmAAIAAANIgmAAIAAAXIAqAAIAAANg");
	this.shape_1.setTransform(22.025,14.75);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#0067AF").s().p("AgGAqIAAhGIgaAAIAAgNIBBAAIAAANIgaAAIAABGg");
	this.shape_2.setTransform(12.25,14.75);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#0067AF").s().p("");
	this.shape_3.setTransform(2.75,14.75);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#0067AF").s().p("AgHAqIAAhTIAPAAIAABTg");
	this.shape_4.setTransform(-4.675,14.75);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#0067AF").s().p("AgMApQgJgDgFgFQgHgGgCgJQgEgHAAgLQAAgJAEgIQACgJAHgFQAFgGAJgDQAIgDAJgBQAKABAIACQAJACAGAGIgLAMQgEgEgGgDQgGgCgGAAQgGAAgFACQgGACgDAFQgEAEgCAFQgCAGgBAGQABAHACAFQACAGAEAEQADAEAGADQAFACAGAAIALgBQAFgBAEgDIAAgUIgRAAIAAgMIAgAAIAAAqQgQAIgTAAQgJAAgIgDg");
	this.shape_5.setTransform(-13.65,14.75);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#0067AF").s().p("AgcAqIAAhTIA3AAIAAANIgoAAIAAAVIAmAAIAAANIgmAAIAAAXIAqAAIAAANg");
	this.shape_6.setTransform(-24.075,14.75);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#0067AF").s().p("AAOAqIgTgkIgLAAIAAAkIgPAAIAAhTIAdAAIALABIALADQAEADACAFQADAEAAAIQAAAJgFAGQgFAGgKABIAXAlgAgQgFIAMAAIAGgBIAFgBIAFgEQACgCAAgEQgBgEgBgCIgFgEQgCgBgDAAIgFgBIgNAAg");
	this.shape_7.setTransform(-33.85,14.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// box
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AnpCOQgeAAAAgeIAAjfQAAgeAeAAIPTAAQAeAAAAAeIAADfQAAAegeAAg");
	this.shape_8.setTransform(0,14.2869,1,1.0018);

	this.timeline.addTween(cjs.Tween.get(this.shape_8).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA, new cjs.Rectangle(-60.4,0.1,120.9,28.5), null);
...
// stage content:
(lib.IFM_Display_Enhance_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(102.5,25.05,0.96,0.96,0,0,0,0.1,0.1);
	...
	this.instance_1.setTransform(246.45,22.4,0.6,0.6,0,0,0,0.1,10);
	...
	this.instance_2.setTransform(162.85,24.95,0.78,0.78);
	...
	this.instance_3.setTransform(162.85,24.95,0.78,0.78);
	...
	this.instance_4.setTransform(162.85,25,0.78,0.78);
	...
	this.instance_5.setTransform(96,45.05,0.192,0.192,0,0,0,0.2,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0,regY:0.1,scaleX:0.6,scaleY:0.6,x:-74,y:78.05},161,cjs.Ease.quadInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-634,-257.2,1280.1,695.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Enhance_320x50_atlas_1.jpg?1604618512692", id:"IFM_Display_Enhance_320x50_atlas_1"}
	],
	preloads: []
};
