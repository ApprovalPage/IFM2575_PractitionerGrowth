...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(150,522,1,1,0,0,0,0,10);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1},191).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Enhance_300x600_atlas_1.jpg?1604438181403", id:"IFM_Display_Enhance_300x600_atlas_1"}
	],
	preloads: []
};
