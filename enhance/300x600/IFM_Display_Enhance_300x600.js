...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(150,442.45,1.6,1.6);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(119).to({_off:false},0).to({alpha:1},10).wait(63));

	// CTA
	this.instance_1 = new lib.CTA();
	this.instance_1.setTransform(150.05,521.4,1.15,1.15,0,0,0,0.1,10.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1},191,cjs.Ease.quadInOut).wait(1));

	// bkgd
	this.instance_6 = new lib.BKGD();
	this.instance_6.setTransform(150,475);
...
p.nominalBounds = new cjs.Rectangle(-300.1,-600.1,1050,2100);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Enhance_300x600_atlas_1.jpg?1604444512381", id:"IFM_Display_Enhance_300x600_atlas_1"}
	],
	preloads: []
};
