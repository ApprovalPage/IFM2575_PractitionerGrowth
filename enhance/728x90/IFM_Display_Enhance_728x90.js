...
lib.ssMetadata = [
		{name:"IFM_Display_Enhance_728x90_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Leaf = function() {
	this.initialize(ss["IFM_Display_Enhance_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Enhance_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(484,40.7,1,1,0,0,0,0,10);
	...
	this.instance_5.setTransform(364.1,45.05,0.32,0.32,0,0,0,0.3,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0.1,scaleX:1,scaleY:1,x:-28.9,y:135.1},161,cjs.Ease.quadInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-865,-420,2036.1,1155.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Enhance_728x90_atlas_1.jpg?1604618507457", id:"IFM_Display_Enhance_728x90_atlas_1"}
	],
	preloads: []
};
