...
lib.ssMetadata = [
		{name:"IFM_Display_Treat_160x600_atlas_1", frames: [[0,0,2400,2400]]}
];
...
(lib._300x600_Iris = function() {
	this.initialize(ss["IFM_Display_Treat_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(67.35,90.825);
	...
	this.shape_1.setTransform(57.525,85.525);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(39.8,85.35);
	...
	this.shape_3.setTransform(19.65,85.525);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAEBSQgFgDgEgEQgEgEgBgHQgDgGAAgGIAAhUIgcAAIAAgPIAcAAIAAglIAQAAIAAAlIAlAAIAAAPIglAAIAABUQAAAIAFAFQAFAEAIABIAKgBIAJgEIABAPIgLADIgKACQgJAAgHgDg");
	this.shape_4.setTransform(6.6,83.85);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(-6.325,88.55);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(-27.05,85.35);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgxBhIgIgBIACgQIAHACIAIABQAEAAAEgCIAGgFIAEgHIADgIIAMgdIg1iCIATAAIAqBsIAqhsIASAAIhCCpQgFAMgIAIQgJAHgOAAg");
	this.shape_7.setTransform(-45.375,88.9);
	...
	this.shape_8.setTransform(-58.025,85.525);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAEBSQgFgDgEgEQgEgFgCgFQgCgHAAgHIAAhTIgcAAIAAgPIAcAAIAAglIAQAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAEAFAJgBIAKgBIAJgDIABAQIgLADIgKABQgJAAgHgDg");
	this.shape_9.setTransform(15.95,50.6);
	...
	this.shape_10.setTransform(3.1,52.275);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AAnBDIAAhMIgBgPQgCgHgDgGQgEgGgGgEQgGgDgKAAQgIAAgJADQgIADgGAHQgGAGgEALQgDAKAAAMIAABBIgRAAIAAhdIAAgIIgBgLIAAgKIAAgHIAQAAIABAOIABAJIABAAQAFgLALgHQAMgJAPABQAPgBAJAGQAKAFAFAHQAGAIACAKQACAKAAAKIAABNg");
	this.shape_11.setTransform(-13.025,52.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD1b, new cjs.Rectangle(-150,-37.7,300,142), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(47.6,26.175);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(36.525,19.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgHBqIAAjTIAQAAIAADTg");
	this.shape_2.setTransform(25.4,14.925);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(13.675,22.05);
	...
	this.shape_4.setTransform(-3.35,19.025);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(-19.425,19.025);
	...
	this.shape_6.setTransform(-35.575,22.05);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAEBSQgFgDgEgEQgEgFgBgGQgCgFgBgHIAAhUIgcAAIAAgPIAcAAIAAglIAQAAIAAAlIAlAAIAAAPIglAAIAABUQAAAIAFAFQAFAFAIAAIAKgCIAJgDIACAQIgMACIgLACQgIAAgHgDg");
	this.shape_7.setTransform(26.05,-15.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(14.1,-14.225);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(-0.775,-14.225);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AggBDIAAhcIAAgJIgBgLIAAgKIAAgHIAQAAIABAOIABAJQAGgLAJgIQAKgHAOgBIAGABIAEABIgCAQIgGgBQgLABgIADQgHADgFAGQgFAHgDAIQgCAIAAAKIAABGg");
	this.shape_10.setTransform(-11.8,-14.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgIBjIAAi1IhEAAIAAgQICZAAIAAAQIhEAAIAAC1g");
	this.shape_11.setTransform(-22.75,-17.65);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD1a, new cjs.Rectangle(-150,-37.7,300,75.5), null);
...
// stage content:
(lib.IFM_Display_Treat_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_2.setTransform(79.95,212.5,1.08,1.08);
	...
	this.instance_3.setTransform(79.95,212.5,1.08,1.08);
	...
	this.instance_4.setTransform(79.95,211.8,1.08,1.08);
	...
	this.instance_5.setTransform(173.8,414.7,0.25,0.25,0,0,0,375.2,458.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.8,regY:457.7,scaleX:0.7399,scaleY:0.7399,x:357.35,y:630.65},167,cjs.Ease.sineInOut).wait(12));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-728.1,-296.6,1696,1476.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Treat_160x600_atlas_1.jpg?1604618695837", id:"IFM_Display_Treat_160x600_atlas_1"}
	],
	preloads: []
};
