...
lib.ssMetadata = [
		{name:"IFM_Display_Treat_728x90_atlas_1", frames: [[0,0,2400,2400]]}
];
...
(lib._300x600_Iris = function() {
	this.initialize(ss["IFM_Display_Treat_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Treat_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_5.setTransform(484.05,191.85,0.32,0.32,0,0,0,375.2,458.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.8,regY:457.7,scaleX:0.7399,scaleY:0.7399,x:641.35,y:383.65},167,cjs.Ease.sineInOut).wait(12));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-160.1,-798.6,1412,1731.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Treat_728x90_atlas_1.jpg?1604618734741", id:"IFM_Display_Treat_728x90_atlas_1"}
	],
	preloads: []
};
