...
lib.ssMetadata = [
		{name:"IFM_Display_Redefine_300x600_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Thumb = function() {
	this.initialize(ss["IFM_Display_Redefine_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Redefine_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Redefine_300x600_atlas_1.jpg?1604618609489", id:"IFM_Display_Redefine_300x600_atlas_1"}
	],
	preloads: []
};
