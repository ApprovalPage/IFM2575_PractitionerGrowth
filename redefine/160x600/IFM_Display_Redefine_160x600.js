...
lib.ssMetadata = [
		{name:"IFM_Display_Redefine_160x600_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Thumb = function() {
	this.initialize(ss["IFM_Display_Redefine_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(51.05,57.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(39.625,52.275);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(23.125,48.35);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgIBhIAAiBIAQAAIAACBgAgIhKQgEgEABgFQgBgGAEgDQAEgEAEAAQAFAAAEAEQAEADAAAGQAAAFgEAEQgEADgFAAQgEAAgEgDg");
	this.shape_3.setTransform(11.4,49.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgHBBIg1iBIATAAIArBvIAqhvIARAAIgzCBg");
	this.shape_4.setTransform(1.575,52.275);
	...
	this.shape_5.setTransform(-13.2,52.275);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AggBDIAAhdIAAgIIgBgLIAAgKIAAgHIAQAAIABAOIABAJQAGgLAJgIQAKgHAOAAIAGAAIAEABIgCAQIgGAAQgLAAgIADQgHAEgFAFQgFAHgDAIQgCAJAAAJIAABGg");
	this.shape_6.setTransform(-24.75,52.1);
	...
	this.shape_7.setTransform(-38.675,55.3);
	...
	this.shape_8.setTransform(68.325,19.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(52.3,19.025);
	...
	this.shape_10.setTransform(37.525,22.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(16.025,19.025);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AggBCIAAhcIgBgIIAAgKIAAgKIgBgIIARAAIABAOIAAAJQAHgMAJgHQAKgIAPABIAEAAIAGABIgCARIgHgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgCAJgBAJIAABFg");
	this.shape_12.setTransform(5,18.85);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("");
	this.shape_13.setTransform(-7.95,19.025);
	...
	this.shape_14.setTransform(-21.175,19.025);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(-43.525,19.025);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAnBqIAAhMIgCgQQgBgHgEgGQgEgFgFgDQgHgEgKAAQgIAAgJADQgIAEgGAFQgGAHgEAKQgDAKAAANIAABBIgRAAIAAjTIARAAIAABpIABAAQAFgLALgHQAMgIAPAAQAPAAAKAFQAJAFAFAHQAGAIACAJQADAKAAALIAABNg");
	this.shape_16.setTransform(-59.05,14.925);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAFBSQgGgDgEgEQgEgEgCgHQgBgFAAgIIAAhTIgcAAIAAgPIAcAAIAAglIAPAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAFAEAIAAIAKAAIAJgEIABAPIgKAEIgLABQgJAAgGgDg");
	this.shape_17.setTransform(-71.65,17.35);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(47.625,-14.225);
	...
	this.shape_1.setTransform(32.025,-14.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgIBhIAAiBIAQAAIAACBgAgIhKQgDgEAAgFQAAgFADgEQAEgEAEAAQAGAAADAEQAEAEAAAFQAAAFgEAEQgDAEgGgBQgEABgEgEg");
	this.shape_2.setTransform(20.95,-17.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgPBsIAAhyIgbAAIAAgPIAbAAIAAgqQAAgNAEgIQAEgIAGgGQAEgEAHgDQAHgCAGAAQAMABAIADIgEAOQgFgCgKAAQgXgBAAAjIAAAkIAfAAIAAAPIgfAAIAAByg");
	this.shape_3.setTransform(14.1,-18.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(1.575,-14.225);
	...
	this.shape_5.setTransform(-14.925,-18.15);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(-31.075,-14.225);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAsBjIg3heIgjAAIAABeIgSAAIAAjFIA0AAIALAAIANACIARAEQAHADAHAGQAGAGAFAJQAEAJAAANQAAAOgFAKQgFAIgIAGQgHAGgJACIgRAEIA6BfgAgugLIAoAAQAOAAAIgDQAKgEAEgFQAFgGADgGIABgLIgBgLQgDgGgFgGQgEgFgKgDQgIgFgOAAIgoAAg");
	this.shape_7.setTransform(-46.25,-17.65);
...
// stage content:
(lib.IFM_Display_Redefine_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Redefine_160x600_atlas_1.jpg?1604618576963", id:"IFM_Display_Redefine_160x600_atlas_1"}
	],
	preloads: []
};
