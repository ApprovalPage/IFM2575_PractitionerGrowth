...
lib.ssMetadata = [
		{name:"IFM_Display_Amplify_320x50_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Leaf = function() {
	this.initialize(ss["IFM_Display_Amplify_320x50_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AvEClIAAlJIeJAAIAAFJg");
	mask.setTransform(56.5,1.5);

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgJAKQgEgEABgGQgBgFAEgEQAFgDAEAAQAFAAAFADQADAEAAAFQAAAGgDAEQgFADgFAAQgEAAgFgDg");
	this.shape.setTransform(133.65,7.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(121.275,-1.55);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAnBCIAAhKIgBgQQgCgHgDgGQgEgGgGgDQgGgEgKAAQgIAAgJADQgIADgGAHQgGAHgEAKQgDAJAAANIAABAIgRAAIAAhcIAAgIIgBgKIAAgKIAAgIIAQAAIABAOIABAJIABAAQAFgLALgIQAMgHAPAAQAPAAAJAEQAKAFAFAIQAGAIACAJQACALAAALIAABLg");
	this.shape_2.setTransform(105.075,2.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(89.95,2.375);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(70.85,2.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(51.225,2.375);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(34.725,-1.55);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AggBCIAAhcIgBgIIAAgKIAAgKIgBgIIARAAIABAOIAAAJQAHgMAJgHQAKgIAPABIAEAAIAGABIgCARIgHgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgCAJgBAJIAABFg");
	this.shape_7.setTransform(15.35,2.2);
	...
	this.shape_8.setTransform(1.975,2.55);
	...
	this.shape_9.setTransform(-14.05,2.375);
	...
	this.shape_10.setTransform(-28.825,5.75);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgxBhIgIgBIACgQIAHACIAIABQAEAAAEgCIAGgFIAEgHIADgIIAMgdIg1iCIATAAIAqBtIAqhtIASAAIhCCpQgFAMgIAIQgJAIgOgBg");
	this.shape_11.setTransform(-49.025,5.75);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgPBrIAAhxIgbAAIAAgPIAbAAIAAgqQABgNADgIQAEgIAGgGQAEgEAHgCQAHgCAGgBQAMAAAIAEIgEAOQgGgDgJAAQgXABAAAiIAAAkIAeAAIAAAPIgeAAIAABxg");
	this.shape_12.setTransform(-59,-1.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgIBgIAAiAIARAAIAACAgAgIhKQgDgEAAgFQAAgGADgDQAEgDAEAAQAGAAADADQAEADgBAGQABAFgEAEQgDAEgGAAQgEAAgEgEg");
	this.shape_13.setTransform(-67.1,-0.8);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgHBqIAAjTIAPAAIAADTg");
	this.shape_14.setTransform(-73.8,-1.725);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(-85.525,5.4);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("");
	this.shape_16.setTransform(-106.25,2.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("ABJBjIgVg1IhoAAIgWA1IgTAAIBWjFIASAAIBUDFgAAtAdIgthrIgtBrIBaAAg");
	this.shape_17.setTransform(-127.65,-1.05);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1b, new cjs.Rectangle(-40,-15,193,33), null);
...
// stage content:
(lib.IFM_Display_Amplify_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Amplify_320x50_atlas_1.jpg?1604687299394", id:"IFM_Display_Amplify_320x50_atlas_1"}
	],
	preloads: []
};
