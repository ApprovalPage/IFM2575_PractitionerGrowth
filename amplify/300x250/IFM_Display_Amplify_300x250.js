...
lib.ssMetadata = [
		{name:"IFM_Display_Amplify_300x250_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Leaf = function() {
	this.initialize(ss["IFM_Display_Amplify_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Amplify_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Amplify_300x250_atlas_1.jpg?1604687293157", id:"IFM_Display_Amplify_300x250_atlas_1"}
	],
	preloads: []
};
