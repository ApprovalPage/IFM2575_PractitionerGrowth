...
lib.ssMetadata = [
		{name:"IFM_Display_Amplify_160x600_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Leaf = function() {
	this.initialize(ss["IFM_Display_Amplify_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(55.45,57.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(43.075,48.35);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAnBDIAAhMIgBgPQgCgHgDgGQgEgGgGgEQgGgDgKAAQgIAAgJADQgIADgGAHQgGAGgEALQgDAKAAAMIAABBIgRAAIAAhdIAAgIIgBgLIAAgKIAAgHIAQAAIABAOIABAJIABAAQAFgLALgHQAMgJAPABQAPgBAJAGQAKAFAFAHQAGAIACAKQACAKAAAKIAABNg");
	this.shape_2.setTransform(26.875,52.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(11.75,52.275);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(-7.35,52.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(-26.975,52.275);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(-43.475,48.35);
	...
	this.shape_7.setTransform(23.45,18.85);
	...
	this.shape_8.setTransform(10.075,19.2);
	...
	this.shape_9.setTransform(-5.95,19.025);
	...
	this.shape_10.setTransform(-20.725,22.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgxBiIgIgCIACgQIAHACIAIABQAEAAAEgCIAGgFIAEgGIADgIIAMgfIg1iBIATAAIAqBsIAqhsIASAAIhCCpQgFAMgIAIQgJAHgOABg");
	this.shape_11.setTransform(40.875,-10.85);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgPBsIAAhyIgbAAIAAgPIAbAAIAAgqQABgNADgIQAEgIAGgGQAEgEAHgDQAHgCAGAAQAMABAIADIgEAOQgGgCgJAAQgXgBAAAjIAAAkIAeAAIAAAPIgeAAIAAByg");
	this.shape_12.setTransform(30.9,-18.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgHBhIAAiBIAQAAIAACBgAgIhKQgEgEAAgFQAAgFAEgEQAEgEAEAAQAGAAADAEQAEAEgBAFQABAFgEAEQgDAEgGgBQgEABgEgEg");
	this.shape_13.setTransform(22.8,-17.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgIBqIAAjTIAQAAIAADTg");
	this.shape_14.setTransform(16.1,-18.325);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(4.375,-11.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("");
	this.shape_16.setTransform(-16.35,-14.4);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("ABJBjIgVg0IhoAAIgWA0IgTAAIBWjFIASAAIBUDFgAAtAeIgthsIgtBsIBaAAg");
	this.shape_17.setTransform(-37.75,-17.65);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgxBiIgIgCIACgQIAHACIAIABQAEAAAEgCIAGgFIAEgGIADgIIAMgfIg1iBIATAAIAqBsIAqhsIASAAIhCCpQgFAMgIAIQgJAHgOABg");
	this.shape.setTransform(40.875,-10.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgPBsIAAhyIgbAAIAAgPIAbAAIAAgqQABgNADgIQAEgIAGgGQAEgEAHgDQAHgCAGAAQAMABAIADIgEAOQgGgCgJAAQgXgBAAAjIAAAkIAeAAIAAAPIgeAAIAAByg");
	this.shape_1.setTransform(30.9,-18.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgHBhIAAiBIAQAAIAACBgAgIhKQgEgEAAgFQAAgFAEgEQAEgEAEAAQAGAAADAEQAEAEgBAFQABAFgEAEQgDAEgGgBQgEABgEgEg");
	this.shape_2.setTransform(22.8,-17.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgIBqIAAjTIAQAAIAADTg");
	this.shape_3.setTransform(16.1,-18.325);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(4.375,-11.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(-16.35,-14.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("ABJBjIgVg0IhoAAIgWA0IgTAAIBWjFIASAAIBUDFgAAtAeIgthsIgtBsIBaAAg");
	this.shape_6.setTransform(-37.75,-17.65);
...
// stage content:
(lib.IFM_Display_Amplify_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(80.05,321.7,1.035,1.035,0,0,0,0.1,10.1);
	...
	this.instance_2.setTransform(79.95,208.1,1.08,1.08);
	...
	this.instance_3.setTransform(79.95,208.1,1.08,1.08);
	...
	this.instance_4.setTransform(79.95,202.75,1.08,1.08);
	...
	this.instance_5.setTransform(80,300,0.25,0.25,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1},161,cjs.Ease.quadInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-440.1,-600.1,1120,2100);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Amplify_160x600_atlas_1.jpg?1604687267127", id:"IFM_Display_Amplify_160x600_atlas_1"}
	],
	preloads: []
};
