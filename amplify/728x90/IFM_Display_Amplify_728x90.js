...
lib.ssMetadata = [
		{name:"IFM_Display_Amplify_728x90_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Leaf = function() {
	this.initialize(ss["IFM_Display_Amplify_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AwUDDIAAmFMAgpAAAIAAGFg");
	mask.setTransform(64.5196,4.5);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1b, new cjs.Rectangle(-40,-15,209,36.1), null);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1a, new cjs.Rectangle(-164,-15,124,36.1), null);
...
// stage content:
(lib.IFM_Display_Amplify_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Amplify_728x90_atlas_1.jpg?1604687274279", id:"IFM_Display_Amplify_728x90_atlas_1"}
	],
	preloads: []
};
