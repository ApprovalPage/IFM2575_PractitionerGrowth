...
lib.ssMetadata = [
		{name:"IFM_Display_Amplify_300x600_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Leaf = function() {
	this.initialize(ss["IFM_Display_Amplify_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(86.3,24.325);
	...
	this.shape_1.setTransform(73.925,15.1);
	...
	this.shape_2.setTransform(57.725,18.85);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(42.6,19.025);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(23.5,18.85);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(3.875,19.025);
	...
	this.shape_6.setTransform(-12.625,15.1);
	...
	this.shape_7.setTransform(-32,18.85);
	...
	this.shape_8.setTransform(-45.375,19.2);
	...
	this.shape_9.setTransform(-61.4,19.025);
	...
	this.shape_10.setTransform(-76.175,22.4);
...
// stage content:
(lib.IFM_Display_Amplify_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Amplify_300x600_atlas_1.jpg?1604687285574", id:"IFM_Display_Amplify_300x600_atlas_1"}
	],
	preloads: []
};
