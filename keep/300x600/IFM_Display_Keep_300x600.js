...
lib.ssMetadata = [
		{name:"IFM_Display_Keep_300x600_atlas_1", frames: [[0,0,2400,2400]]}
];
...
(lib._300x600_Iris = function() {
	this.initialize(ss["IFM_Display_Keep_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgJAKQgDgEAAgGQAAgFADgEQAEgDAFAAQAGAAADADQAEAEABAFQgBAGgEAEQgDADgGAAQgFAAgEgDg");
	this.shape.setTransform(27.95,57.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgIBqIAAjTIAQAAIAADTg");
	this.shape_1.setTransform(20.95,48.175);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgHBqIAAjTIAQAAIAADTg");
	this.shape_2.setTransform(14.25,48.175);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(3.125,52.275);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAnBBIgnhpIAAAAIgkBpIgRAAIgoiBIASAAIAfBsIABAAIAlhsIAOAAIAnBsIAAAAIAehsIASAAIgmCBg");
	this.shape_4.setTransform(-14.5,52.275);
	...
	this.shape_5.setTransform(74.625,19.025);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAFBSQgGgDgEgEQgEgEgCgHQgBgFAAgIIAAhTIgcAAIAAgPIAcAAIAAglIAPAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAEAEAJAAIAKAAIAJgEIACAPIgLAEIgMABQgIAAgGgDg");
	this.shape_6.setTransform(64.15,17.35);
	...
	this.shape_7.setTransform(51.775,18.85);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(36.275,19.025);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgIBgIAAiAIARAAIAACAgAgIhKQgDgEAAgFQAAgGADgDQAEgDAEAAQAGAAADADQAEADgBAGQABAFgEAEQgDAEgGAAQgEAAgEgEg");
	this.shape_9.setTransform(25.15,15.85);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAFBSQgGgDgEgEQgEgEgCgHQgBgFAAgIIAAhTIgcAAIAAgPIAcAAIAAglIAPAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAFAEAIAAIAKAAIAJgEIABAPIgKAEIgLABQgJAAgGgDg");
	this.shape_10.setTransform(17,17.35);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(5.05,19.025);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("");
	this.shape_12.setTransform(-10.425,22.05);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AggBCIAAhcIAAgIIgBgKIAAgKIAAgIIAQAAIABAOIABAJQAGgMAJgHQAKgIAOABIAGAAIAEABIgCARIgGgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgCAJAAAJIAABFg");
	this.shape_13.setTransform(-30.15,18.85);
	...
	this.shape_14.setTransform(-43.525,19.2);
	...
	this.shape_15.setTransform(-59.55,19.025);
	...
	this.shape_16.setTransform(-74.325,22.4);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(24.275,-11.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(7.775,-14.225);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(-7.775,-14.225);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAvBjIhjhmIgCAAIAABmIgTAAIAAjFIATAAIAABXIACAAIBfhXIAZAAIhjBaIBpBrg");
	this.shape_3.setTransform(-22.575,-17.65);
...
// stage content:
(lib.IFM_Display_Keep_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_5.setTransform(243.8,414.7,0.25,0.25,0,0,0,375.2,458.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.8,regY:457.7,scaleX:0.7399,scaleY:0.7399,x:427.35,y:630.65},167,cjs.Ease.sineInOut).wait(12));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-588.1,-296.6,1626,1476.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Keep_300x600_atlas_1.jpg?1604691642251", id:"IFM_Display_Keep_300x600_atlas_1"}
	],
	preloads: []
};
