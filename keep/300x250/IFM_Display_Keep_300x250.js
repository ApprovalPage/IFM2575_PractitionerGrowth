...
lib.ssMetadata = [
		{name:"IFM_Display_Keep_300x250_atlas_1", frames: [[0,0,2400,2400]]}
];
...
(lib._300x600_Iris = function() {
	this.initialize(ss["IFM_Display_Keep_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(112.4,24.325);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgHBqIAAjTIAQAAIAADTg");
	this.shape_1.setTransform(105.4,14.925);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgIBqIAAjTIAQAAIAADTg");
	this.shape_2.setTransform(98.7,14.925);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(87.575,19.025);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAnBBIgmhpIgBAAIgjBpIgRAAIgqiBIATAAIAgBsIAAAAIAlhsIAOAAIAnBsIAAAAIAehsIARAAIgmCBg");
	this.shape_4.setTransform(69.95,19.025);
	...
	this.shape_5.setTransform(46.675,19.025);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAEBSQgFgDgEgEQgEgEgCgHQgCgFAAgIIAAhTIgcAAIAAgPIAcAAIAAglIAQAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAEAEAJAAIAKAAIAJgEIABAPIgLAEIgKABQgJAAgHgDg");
	this.shape_6.setTransform(36.2,17.35);
	...
	this.shape_7.setTransform(23.825,18.85);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(8.325,19.025);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgIBgIAAiAIAQAAIAACAgAgIhKQgDgEgBgFQABgGADgDQAEgDAEAAQAFAAAEADQADADABAGQgBAFgDAEQgEAEgFAAQgEAAgEgEg");
	this.shape_9.setTransform(-2.8,15.85);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAEBSQgFgDgEgEQgEgEgBgHQgDgFAAgIIAAhTIgcAAIAAgPIAcAAIAAglIAQAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAFAEAIAAIAKAAIAJgEIABAPIgLAEIgLABQgIAAgHgDg");
	this.shape_10.setTransform(-10.95,17.35);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(-22.9,19.025);
	...
	this.shape_12.setTransform(-38.375,22.05);
	...
	this.shape_13.setTransform(-58.1,18.85);
	...
	this.shape_14.setTransform(-71.475,19.2);
	...
	this.shape_15.setTransform(-87.5,19.025);
	...
	this.shape_16.setTransform(-102.275,22.4);
...
// stage content:
(lib.IFM_Display_Keep_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(123).to({_off:false},0).to({alpha:1},10).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(147).to({_off:false},0).to({alpha:1},10).wait(22));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off:false},0).to({alpha:1},10).to({_off:true},65).wait(100));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(31).to({_off:false},0).to({alpha:1},10).to({_off:true},38).wait(100));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(79).to({_off:false},0).to({alpha:1},10).to({_off:true},34).wait(56));

	// bkgd-pattern
	this.instance_5 = new lib.patternirisBLUE30();
	this.instance_5.setTransform(198.75,184.6,0.13,0.13,0,0,0,375.1,458.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:374.8,regY:457.7,scaleX:0.7399,scaleY:0.7399,x:422.65,y:449.9},167,cjs.Ease.sineInOut).wait(12));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-592.7,-652.2,1625.9,1651.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Keep_300x250_atlas_1.jpg?1604691651779", id:"IFM_Display_Keep_300x250_atlas_1"}
	],
	preloads: []
};
