...
lib.ssMetadata = [
		{name:"IFM_Display_Keep_160x600_atlas_1", frames: [[0,0,2400,2400]]}
];
...
(lib._300x600_Iris = function() {
	this.initialize(ss["IFM_Display_Keep_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_5.setTransform(43.775,52.275);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAFBSQgGgDgEgEQgEgFgCgFQgCgHABgHIAAhTIgcAAIAAgPIAcAAIAAglIAPAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAFAFAIgBIAKgBIAJgDIABAQIgKADIgLABQgJAAgGgDg");
	this.shape_6.setTransform(33.3,50.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAnBDIAAhMIgBgPQgCgHgDgGQgEgGgGgEQgGgDgKAAQgIAAgJADQgIADgGAHQgGAGgEALQgDAKAAAMIAABBIgRAAIAAhdIAAgIIgBgLIAAgKIAAgHIAQAAIABAOIABAJIABAAQAFgLALgHQAMgJAPABQAPgBAJAGQAKAFAFAHQAGAIACAKQACAKAAAKIAABNg");
	this.shape_7.setTransform(20.925,52.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(5.425,52.275);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgIBhIAAiBIAQAAIAACBgAgIhKQgEgEABgFQgBgGAEgDQAEgEAEAAQAFAAAEAEQAEADAAAGQAAAFgEAEQgEADgFAAQgEAAgEgDg");
	this.shape_9.setTransform(-5.7,49.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAEBSQgFgDgEgEQgEgFgCgFQgCgHAAgHIAAhTIgcAAIAAgPIAcAAIAAglIAQAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAEAFAJgBIAKgBIAJgDIABAQIgLADIgKABQgJAAgHgDg");
	this.shape_10.setTransform(-13.85,50.6);
	...
	this.shape_11.setTransform(-25.8,52.275);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("");
	this.shape_12.setTransform(-41.275,55.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AggBCIAAhcIgBgIIAAgKIAAgKIgBgIIARAAIABAOIAAAJQAHgMAJgHQAKgIAPABIAEAAIAGABIgCARIgHgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgCAJgBAJIAABFg");
	this.shape_13.setTransform(23.45,18.85);
	...
	this.shape_14.setTransform(10.075,19.2);
	...
	this.shape_15.setTransform(-5.95,19.025);
	...
	this.shape_16.setTransform(-20.725,22.4);
...
// stage content:
(lib.IFM_Display_Keep_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Keep_160x600_atlas_1.jpg?1604691635871", id:"IFM_Display_Keep_160x600_atlas_1"}
	],
	preloads: []
};
