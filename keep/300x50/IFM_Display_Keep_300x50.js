...
lib.ssMetadata = [
		{name:"IFM_Display_Keep_300x50_atlas_1", frames: [[0,0,2400,2400]]}
];
...
(lib._300x600_Iris = function() {
	this.initialize(ss["IFM_Display_Keep_300x50_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Keep_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Keep_300x50_atlas_1.jpg?1604691666302", id:"IFM_Display_Keep_300x50_atlas_1"}
	],
	preloads: []
};
