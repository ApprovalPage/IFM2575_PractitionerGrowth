...
lib.ssMetadata = [
		{name:"IFM_Display_Keep_320x50_atlas_1", frames: [[0,0,2400,2400]]}
];
...
(lib._300x600_Iris = function() {
	this.initialize(ss["IFM_Display_Keep_320x50_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AzmC+IAAl7MAnNAAAIAAF7g");
	mask.setTransform(43.4464,3.95);

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgJAKQgDgEAAgGQAAgFADgEQAEgDAFAAQAFAAAEADQAFAEAAAFQAAAGgFAEQgEADgFAAQgFAAgEgDg");
	this.shape.setTransform(145.05,7.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgIBqIAAjTIAQAAIAADTg");
	this.shape_1.setTransform(138.05,-1.725);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgHBqIAAjTIAQAAIAADTg");
	this.shape_2.setTransform(131.35,-1.725);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(120.225,2.375);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAnBBIgmhpIgBAAIgkBpIgQAAIgpiBIASAAIAgBsIAAAAIAlhsIAOAAIAnBsIAAAAIAehsIARAAIglCBg");
	this.shape_4.setTransform(102.6,2.375);
	...
	this.shape_5.setTransform(79.325,2.375);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAEBSQgFgDgEgEQgEgEgCgHQgCgFABgIIAAhTIgcAAIAAgPIAcAAIAAglIAPAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAFAEAIABIAKgBIAJgEIABAPIgKAEIgLABQgJAAgHgDg");
	this.shape_6.setTransform(68.85,0.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAnBCIAAhKIgBgQQgCgHgDgGQgEgGgGgDQgGgEgKAAQgIAAgJADQgIADgGAHQgGAHgEAKQgDAJAAANIAABAIgRAAIAAhcIAAgIIgBgKIAAgKIAAgIIAQAAIABAOIABAJIABAAQAFgLALgIQAMgHAPAAQAPAAAJAEQAKAFAFAIQAGAIACAJQACALAAALIAABLg");
	this.shape_7.setTransform(56.475,2.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(40.975,2.375);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgIBgIAAiAIAQAAIAACAgAgIhKQgEgEABgFQgBgGAEgDQAEgDAEAAQAFAAAEADQAEADAAAGQAAAFgEAEQgEAEgFAAQgEAAgEgEg");
	this.shape_9.setTransform(29.85,-0.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAEBSQgFgDgEgEQgEgEgCgHQgCgFAAgIIAAhTIgcAAIAAgPIAcAAIAAglIAQAAIAAAlIAlAAIAAAPIglAAIAABTQAAAJAFAFQAEAEAJABIAKgBIAJgEIABAPIgLAEIgKABQgJAAgHgDg");
	this.shape_10.setTransform(21.7,0.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(9.75,2.375);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("");
	this.shape_12.setTransform(-5.725,5.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AggBCIAAhcIgBgIIAAgKIAAgKIAAgIIAQAAIABAOIABAJQAGgMAJgHQAKgIAOABIAFAAIAGABIgDARIgGgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgDAJABAJIAABFg");
	this.shape_13.setTransform(-25.45,2.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgfA+QgJgFgGgIQgFgIgCgKQgCgJAAgMIAAhMIAQAAIAABMIACAPQABAIAEAFQADAHAHACQAGAEAKAAQAIAAAJgDQAIgDAGgHQAGgGADgLQAEgKAAgLIAAhCIARAAIAABdIAAAJIAAAKIABAKIAAAHIgRAAIAAgOIgBgJIgBAAQgFALgLAHQgMAJgPgBQgPAAgKgEg");
	this.shape_14.setTransform(-38.825,2.55);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(-54.85,2.375);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgxBhIgIgBIACgQIAHACIAIABQAEAAAEgCIAGgFIAEgHIADgIIAMgdIg1iCIATAAIAqBtIAqhtIASAAIhCCpQgFAMgIAIQgJAIgOgBg");
	this.shape_16.setTransform(-69.625,5.75);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("");
	this.shape_17.setTransform(-91.725,5.4);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("");
	this.shape_18.setTransform(-108.225,2.375);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("");
	this.shape_19.setTransform(-123.775,2.375);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AAvBjIhjhmIgCAAIAABmIgTAAIAAjFIATAAIAABXIACAAIBfhXIAZAAIhjBbIBpBqg");
	this.shape_20.setTransform(-138.575,-1.05);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1b, new cjs.Rectangle(-82,-15,251,36.1), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvjC+IAAl7ISSAAIAAF7g");
	mask.setTransform(-99.5711,3.95);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1a, new cjs.Rectangle(-199.1,-15,117.1,36.1), null);
...
// stage content:
(lib.IFM_Display_Keep_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Keep_320x50_atlas_1.jpg?1604691659707", id:"IFM_Display_Keep_320x50_atlas_1"}
	],
	preloads: []
};
