...
lib.ssMetadata = [
		{name:"IFM_Display_Expand_320x50_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Giraffe = function() {
	this.initialize(ss["IFM_Display_Expand_320x50_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AygC5IAAlxMAlBAAAIAAFxg");
	mask.setTransform(56.5355,3.5);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1b, new cjs.Rectangle(-61.9,-15,237,36.1), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AszC5IAAlxIP7AAIAAFxg");
	mask.setTransform(-82.0008,3.5);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1a, new cjs.Rectangle(-164,-15,102,36.1), null);
...
// stage content:
(lib.IFM_Display_Expand_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Expand_320x50_atlas_1.jpg?1604685904204", id:"IFM_Display_Expand_320x50_atlas_1"}
	],
	preloads: []
};
