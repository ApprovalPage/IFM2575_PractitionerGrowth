...
lib.ssMetadata = [
		{name:"IFM_Display_Expand_160x600_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Giraffe = function() {
	this.initialize(ss["IFM_Display_Expand_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.patterngiraffe30, new cjs.Rectangle(-600,-1200,1200,2400), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgIAKQgEgEgBgGQABgFAEgEQADgDAFAAQAGAAADADQAEAEAAAFQAAAGgEAEQgDADgGAAQgFAAgDgDg");
	this.shape.setTransform(45.85,57.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(34.425,52.275);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AggBDIAAhdIAAgIIgBgLIAAgKIAAgHIAQAAIABAOIABAJQAGgLAJgIQAKgHAOAAIAGAAIAEABIgCAQIgGAAQgLAAgIADQgHAEgFAFQgFAHgDAIQgCAJAAAJIAABGg");
	this.shape_2.setTransform(23.4,52.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(10.45,52.275);
	...
	this.shape_4.setTransform(-2.775,52.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgPBsIAAhyIgbAAIAAgPIAbAAIAAgqQABgNADgIQAEgIAGgFQAEgFAHgDQAHgBAGAAQAMAAAIADIgEAPQgGgDgJAAQgXgBAAAjIAAAkIAeAAIAAAPIgeAAIAAByg");
	this.shape_5.setTransform(-20.85,48);
	...
	this.shape_6.setTransform(-33.9,52.275);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgHBqIAAjTIAQAAIAADTg");
	this.shape_7.setTransform(59.8,14.925);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(48.675,19.025);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgHBBIg1iBIATAAIArBvIAqhvIARAAIgzCBg");
	this.shape_9.setTransform(34.425,19.025);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("");
	this.shape_10.setTransform(20.175,19.025);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgIBqIAAjTIAQAAIAADTg");
	this.shape_11.setTransform(9.05,14.925);
	...
	this.shape_12.setTransform(-5.3,18.85);
	...
	this.shape_13.setTransform(-18.675,19.2);
	...
	this.shape_14.setTransform(-34.7,19.025);
	...
	this.shape_15.setTransform(-49.475,22.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD1b, new cjs.Rectangle(-150,-37.7,300,108.7), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(38.425,-18.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAnBDIAAhMIgBgPQgCgHgDgGQgEgGgGgEQgGgDgKAAQgIAAgJADQgIADgGAHQgGAGgEAKQgDALAAAMIAABBIgRAAIAAhcIAAgJIgBgLIAAgKIAAgHIAQAAIABAOIABAJIABAAQAFgLALgIQAMgIAPAAQAPAAAJAGQAKAEAFAIQAGAIACAJQACALAAAKIAABNg");
	this.shape_1.setTransform(22.225,-14.4);
	...
	this.shape_2.setTransform(7.1,-14.225);
	...
	this.shape_3.setTransform(-8.375,-11.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAsBBIgsg7IgsA7IgVAAIA2hFIgug8IAWAAIAjAxIAjgxIAVAAIguA8IA4BFg");
	this.shape_4.setTransform(-23.825,-14.225);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ag+BjIAAjFIB4AAIAAAQIhlAAIAABHIBfAAIAAAQIhfAAIAABNIBqAAIAAARg");
	this.shape_5.setTransform(-38.15,-17.65);
...
// stage content:
(lib.IFM_Display_Expand_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(80.15,242.4,1,1,0,0,0,0.1,0.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(117).to({_off:false},0).to({x:80.05,alpha:1},10).wait(52));

	// CTA
	this.instance_1 = new lib.CTA();
	this.instance_1.setTransform(80.05,322.3,1.035,1.035,0,0,0,0.1,10.1);
	...
	this.instance_2.setTransform(79.95,208.05,1.08,1.08);
	...
	this.instance_3.setTransform(79.95,208.05,1.08,1.08);
	...
	this.instance_4.setTransform(79.95,207.35,1.08,1.08);
	...
	this.instance_5.setTransform(173.7,414.45,0.25,0.25,0,0,0,374.8,457.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:375.1,regY:457.7,scaleX:1,scaleY:1,x:455.1,y:757.7},167,cjs.Ease.sineInOut).wait(12));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-440,-600.1,1120.2,2100.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Expand_160x600_atlas_1.jpg?1604685916765", id:"IFM_Display_Expand_160x600_atlas_1"}
	],
	preloads: []
};
