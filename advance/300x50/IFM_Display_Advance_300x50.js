...
lib.ssMetadata = [
		{name:"IFM_Display_Advance_300x50_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Giraffe = function() {
	this.initialize(ss["IFM_Display_Advance_300x50_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Advance_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(94.05,25.05,0.96,0.96,0,0,0,0.1,0.1);
	...
	this.instance_1.setTransform(238,19.25,0.6,0.6,0,0,0,0.1,10.1);
	...
	this.instance_2.setTransform(150.4,24.95,0.78,0.78);
	...
	this.instance_3.setTransform(150.4,24.95,0.78,0.78);
	...
	this.instance_4.setTransform(150.4,25,0.78,0.78);
	...
	this.instance_5.setTransform(219.7,110.2,0.186,0.186,0,0,0,375.1,458.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:457.8,scaleX:0.6,scaleY:0.6,x:375,y:299.55},161,cjs.Ease.sineInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-420,-310.3,1290,695.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Advance_300x50_atlas_1.jpg?1604618464844", id:"IFM_Display_Advance_300x50_atlas_1"}
	],
	preloads: []
};
