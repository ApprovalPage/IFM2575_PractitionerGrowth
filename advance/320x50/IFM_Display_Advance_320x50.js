...
lib.ssMetadata = [
		{name:"IFM_Display_Advance_320x50_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Giraffe = function() {
	this.initialize(ss["IFM_Display_Advance_320x50_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AviCWIAAkrIfFAAIAAErg");
	mask.setTransform(59.55,0);

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgJAKQgDgEAAgGQAAgFADgEQAFgDAEAAQAFAAAEADQAFAEAAAFQAAAGgFAEQgEADgFAAQgEAAgFgDg");
	this.shape.setTransform(147.4,7.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAnBqIAAhMIgCgQQgCgHgDgGQgEgFgGgDQgGgEgKAAQgIAAgJADQgIAEgGAFQgGAHgDAKQgEAKAAANIAABBIgRAAIAAjTIARAAIAABpIABAAQAFgLALgHQANgIAOAAQAPAAAKAFQAJAFAGAHQAFAIACAJQACAKABALIAABNg");
	this.shape_1.setTransform(136,-1.725);
	...
	this.shape_2.setTransform(122.075,2.375);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(107.35,2.375);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(91.95,2.375);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AggBCIAAhcIgBgIIAAgKIAAgKIgBgIIARAAIABAOIAAAJQAHgMAJgHQAKgIAPABIAEAAIAGABIgDARIgGgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgCAJgBAJIAABFg");
	this.shape_5.setTransform(80.4,2.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(66.475,5.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(49.375,5.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(33.25,2.375);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AggBCIAAhcIgBgIIAAgKIAAgKIgBgIIARAAIABAOIAAAJQAHgMAJgHQAKgIAPABIAEAAIAGABIgDARIgGgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgCAJgBAJIAABFg");
	this.shape_9.setTransform(15.15,2.2);
	...
	this.shape_10.setTransform(1.775,2.55);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(-14.25,2.375);
	...
	this.shape_12.setTransform(-29.025,5.75);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("");
	this.shape_13.setTransform(-50.525,2.375);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgQA/QgNgFgJgJQgJgJgFgNQgFgMAAgPQAAgOAFgMQAFgNAJgJQAJgJANgFQAMgFAOAAQAOAAAMAGQANAGAJAKIgNALQgIgJgIgEQgJgFgKAAQgLAAgJAEQgKAFgHAHQgGAHgEAJQgDAKAAAKQAAALADAKQAEAJAGAHQAHAIAKAEQAJAEALAAQALAAAIgFQAJgFAHgIIAMALQgJALgMAGQgMAFgOAAQgOAAgMgFg");
	this.shape_14.setTransform(-64.425,2.375);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AAnBCIAAhKIgBgQQgCgHgDgGQgEgGgGgDQgGgEgKAAQgIAAgJADQgIADgGAHQgGAHgEAKQgDAJAAANIAABAIgRAAIAAhcIAAgIIgBgKIAAgKIAAgIIAQAAIABAOIABAJIABAAQAFgLALgIQAMgHAPAAQAPAAAJAEQAKAFAFAIQAGAIACAJQACALAAALIAABLg");
	this.shape_15.setTransform(-79.575,2.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("");
	this.shape_16.setTransform(-94.7,2.375);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgHBBIg1iBIATAAIArBvIAqhvIARAAIgzCBg");
	this.shape_17.setTransform(-108.275,2.375);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("");
	this.shape_18.setTransform(-123.475,-1.55);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("ABKBjIgWg1IhoAAIgWA1IgTAAIBWjFIASAAIBUDFgAAtAdIgthrIgtBrIBaAAg");
	this.shape_19.setTransform(-141.4,-1.05);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1b, new cjs.Rectangle(-39.9,-15,199,30), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AprCWIAAkrITXAAIAAErg");
	mask.setTransform(-102,0);
...
}).prototype = getMCSymbolPrototype(lib.HEAD1a, new cjs.Rectangle(-164,-15,124,30), null);
...
// stage content:
(lib.IFM_Display_Advance_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(104.05,25.05,0.96,0.96,0,0,0,0.1,0.1);
	...
	this.instance_1.setTransform(248,19.25,0.6,0.6,0,0,0,0.1,10.1);
	...
	this.instance_2.setTransform(160.4,24.95,0.78,0.78);
	...
	this.instance_3.setTransform(160.4,24.95,0.78,0.78);
	...
	this.instance_4.setTransform(160.4,25,0.78,0.78);
	...
	this.instance_5.setTransform(229.7,110.2,0.186,0.186,0,0,0,375.1,458.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:457.8,scaleX:0.6,scaleY:0.6,x:385,y:299.55},161,cjs.Ease.sineInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-400,-310.3,1280,695.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Advance_320x50_atlas_1.jpg?1604618445579", id:"IFM_Display_Advance_320x50_atlas_1"}
	],
	preloads: []
};
