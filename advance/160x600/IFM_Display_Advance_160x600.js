...
lib.ssMetadata = [
		{name:"IFM_Display_Advance_160x600_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Giraffe = function() {
	this.initialize(ss["IFM_Display_Advance_160x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(62.45,57.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAmBqIAAhMIgBgQQgCgHgDgGQgDgFgHgDQgGgEgKAAQgIAAgJADQgIAEgGAFQgGAHgDAKQgEAKAAANIAABBIgQAAIAAjTIAQAAIAABpIABAAQAFgLALgHQANgIAOAAQAPAAAJAFQAKAFAGAHQAFAIACAJQACAKABALIAABNg");
	this.shape_1.setTransform(51.05,48.175);
	...
	this.shape_2.setTransform(37.125,52.275);
	...
	this.shape_3.setTransform(22.4,52.275);
	...
	this.shape_4.setTransform(7,52.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AggBDIAAhdIgBgIIAAgLIAAgKIgBgHIARAAIABAOIAAAJQAHgLAJgIQAKgHAPAAIAEAAIAGABIgCAQIgHAAQgLAAgIADQgHAEgFAFQgFAHgDAIQgCAJgBAJIAABGg");
	this.shape_5.setTransform(-4.55,52.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(-18.475,55.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(-35.575,55.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(-51.7,52.275);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AggBCIAAhcIgBgIIAAgKIAAgKIgBgIIARAAIABAOIAAAJQAHgMAJgHQAKgIAPABIAEAAIAGABIgCARIgHgCQgLAAgIAEQgHAEgFAGQgFAGgDAIQgCAJgBAJIAABFg");
	this.shape_9.setTransform(27.05,18.85);
	...
	this.shape_10.setTransform(13.675,19.2);
	...
	this.shape_11.setTransform(-2.35,19.025);
	...
	this.shape_12.setTransform(-17.125,22.4);
...
// stage content:
(lib.IFM_Display_Advance_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Advance_160x600_atlas_1.jpg?1604618469325", id:"IFM_Display_Advance_160x600_atlas_1"}
	],
	preloads: []
};
