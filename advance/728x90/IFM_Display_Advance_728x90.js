...
lib.ssMetadata = [
		{name:"IFM_Display_Advance_728x90_atlas_1", frames: [[0,0,1200,2400]]}
];
...
(lib._300x600_Giraffe = function() {
	this.initialize(ss["IFM_Display_Advance_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IFM_Display_Advance_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:375.1,regY:457.7,scaleX:1,scaleY:1,x:1596,y:603.55},161,cjs.Ease.sineInOut).wait(18));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(267.3,-409.4,2153.7,1155.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IFM_Display_Advance_728x90_atlas_1.jpg?1604618434939", id:"IFM_Display_Advance_728x90_atlas_1"}
	],
	preloads: []
};
